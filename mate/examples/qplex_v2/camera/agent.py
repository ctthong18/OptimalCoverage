...
from ray.rllib.agents.qplex_v2.qplex import QPLEXTorchPolicy
import mate
from examples.qplex_v2.camera.config import config as _config
from examples.qplex_v2.camera.config import make_env as _make_env
from examples.utils import RLlibGroupedPolicyMixIn


class QPLEXV2CameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """QPLEX Camera Agent
