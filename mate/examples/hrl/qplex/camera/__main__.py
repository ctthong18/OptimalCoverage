...
r"""
Example of hierarchical QPLEX agents for the Multi-Agent Tracking Environment.
...
.. code:: bash
    ...
    python3 -m mate.evaluate --episodes 1 --render-communication \
        --camera-agent examples.hrl:HRLQPLEXCameraAgent \
...
import mate
from examples.hrl.qplex.camera.agent import HRLQPLEXCameraAgent
from examples.hrl.qplex.camera.train import experiment
...
def main():
    ...
    # Make agents ##############################################################
    camera_agent = HRLQPLEXCameraAgent(checkpoint_path=args.checkpoint_path)
