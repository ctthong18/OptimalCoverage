...
# from ..utils.qplex_policy import QPLEXTorchPolicy
from ray.rllib.agents.qplex.qplex import QPLEXTorchPolicy
import mate
from examples.qplex.camera.config import config as _config
from examples.qplex.camera.config import make_env as _make_env
from examples.utils import RLlibGroupedPolicyMixIn


class QPLEXCameraAgent(RLlibGroupedPolicyMixIn, mate.CameraAgentBase):
    """QPLEX Camera Agent
