...
.. code:: bash
    ...
    python3 -m mate.evaluate --episodes 1 --render-communication \
        --camera-agent examples.qplex:QPLEXCameraAgent \
...
import mate
from examples.qplex.camera.agent import QPLEXCameraAgent
from examples.qplex.camera.train import experiment
